...
gui.add(parameters, 'radius').min(0.01).max(0.1).step(0.01).onFinishChange(generateGalaxy);
gui.add(parameters, 'branches').min(1).max(20).step(1).onFinishChange(generateGalaxy);
gui.add(parameters, 'spin').min(- 5).max(5).step(0.001).onFinishChange(generateGalaxy);
gui.add(parameters, 'randomness').min(0.00).max(1.0).step(0.01).onFinishChange(generateGalaxy);
